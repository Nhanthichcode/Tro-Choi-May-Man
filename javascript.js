...
function createWaveControls() {
  ...
  const html = `
    <div class="wave-controls-section">
      ...
      <div class="wave-control-group"><label class="wave-label">Thời gian</label><input type="range" id="wave-duration" min="2000" max="10000" value="${waveConfig.duration}" step="1000"></div>
